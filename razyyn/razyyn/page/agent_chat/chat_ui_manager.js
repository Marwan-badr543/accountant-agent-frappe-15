		...
		let welcome_html = `
			<div class="agent-welcome-state">
				...
				<p class="text-muted" style="max-width: 440px; margin: 0 auto; font-size: 14px; line-height: 1.5;">
					${__(
						"Select your agent mode (Ask, Analyse, or Audit) and upload financial documents or ask questions directly."
					)}
				</p>
				<div class="agent-suggestions-grid">
					<div class="agent-suggestion-card" data-prompt="${__(
						"Compare bank statements and ledger entries to find any discrepancies."
					)}">
					...
					<div class="agent-suggestion-card" data-prompt="${__(
						"Provide a complete summary of our cash flow status and highlight any liquidity risks."
					)}">
						<div class="agent-suggestion-card-header">
					...
					<div class="agent-suggestion-card" data-prompt="${__(
						"Run an audit check on all expenses from the past 30 days and flag any policy violations."
					)}">
						<div class="agent-suggestion-card-header">
					...
					<div class="agent-suggestion-card" data-prompt="${__(
						"Can you list all outstanding invoices that are overdue and calculate the total amount?"
					)}">
						<div class="agent-suggestion-card-header">
