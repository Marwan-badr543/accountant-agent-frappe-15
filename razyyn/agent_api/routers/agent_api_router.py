...
def _extract_api_key(explicit_value: str | None = None) -> str | None:
	...
	return frappe.form_dict.get("api_key") or frappe.request.headers.get("X-API-Key")
...
def request_clarification(
	...
	try:
		settings_user = authenticate_by_api_key(resolved_api_key)
		return process_clarification_request(resolved_session_id, resolved_questions, settings_user)
